...
async def inline_handler(event):  
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**senzirbot"):
            buttons = [
                (
                    ...
                    Button.url("البرنس", "https://github.com/albrans133/source"),
                )
            ]
            ...
            result = builder.article(
                title="رسالة سرية",
                text=f"🔒 عيب  الرسالة مش لك 😂 {sandy}, ",
                buttons=buttons,
            )
            await event.answer([result] if result else None)
            if jsondata:
            ...
            buttons = [
                Button.inline(text="أظهار الخيارات.", data="show_pmpermit_options"),
            ]
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/albrans133/source_albrans"),
                Button.url(
                    "Deploy",
        ...
        result = types.InputBotInlineResult(
            ...
            url="https://dashboard.heroku.com/new?template=https://github.com/albrans133/source",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
